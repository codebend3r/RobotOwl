...
/* NEW FILE */$.fn.crivasgallery = function (options) {
...
Crivas.createCookie = function(name, value, days) {
  if (days) {
    var date = new Date();
...
Crivas.readCookie = function(name) {
  var nameEQ = name + "=";
...
Crivas.eraseCookie = function(name) {
  createCookie(name, "", -1);
}
...
$("#contact").submit(function (e) {
  ...
  var dataString = 'firstname=' + firstname + '&lastname=' + lastname + '&telephone=' + telephone + '&email=' + email + '&message=' + message;
